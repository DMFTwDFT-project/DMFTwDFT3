...
p = {"Niter":     5,               # Number of DFT+DMFT iterations
     ...
     "print_at":  ['Ni1','Ni2'],     # The local Green functions are printed"],
     "Nrelax" : 0,
     "path_bin":  "/home/uthpala/Documents/Research/CondensedMatterResearch/projects/DFTDMFT/bin/",     # Path to bin files
     }
